    ...
    <div className="w-full bg-black">
      <div className="min-h-screen text-slate-100 p-4 md:p-12">
        <div className="w-full md:w-[78%] mx-auto">
          ...
          {/* HEADER */}
          <header className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6 py-4 md:py-8">
          ...
          <main className="mt-4 md:mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <aside className="md:col-span-1 bg-white/5 rounded-xl p-4 md:p-6">
              <h4 className="text-white font-semibold text-left">Key points</h4>
              <p className="text-slate-300 text-sm mt-2 text-left">What you should know at a glance:</p>

              <ul className="mt-4 space-y-3 text-sm text-slate-100">
                <li className="flex items-start gap-3">
                  <span className="w-3 h-3 rounded-full mt-1" style={{ background: 'linear-gradient(90deg,#43D9FA,#FA1CD4)' }} />
                  <span className="text-left">We collect account, usage, and technical data to operate the service.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-3 h-3 rounded-full mt-1" style={{ background: 'linear-gradient(90deg,#43D9FA,#FA1CD4)' }} />
                  <span className="text-left">You can request access, correction, or deletion of your data.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-3 h-3 rounded-full mt-1" style={{ background: 'linear-gradient(90deg,#43D9FA,#FA1CD4)' }} />
                  <span className="text-left">Contact support@suno.ai for privacy requests.</span>
                </li>
              </ul>

              <a
                className="inline-block mt-4 px-3 py-2 rounded-lg font-semibold text-black text-sm md:text-base bg-gradient-to-r from-[#43D9FA] to-[#FA1CD4]"
                href="#"
              >
