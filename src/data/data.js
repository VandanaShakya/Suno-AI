...
export const pricingData = [
  ...
  export const pricingPlans = [
  {
    ...
    button: { text: "Activate Free", gradient: "from-[#43D9FA] to-[#FA1CD4]" },
  },
  {
    title: "Pro Plan",
    subtitle: "For regular creators and professionals.",
    price: "$10",
    planType: "pro",
    credits: 10,
    features: [
    ...
    button: { text: "Get Pro", gradient: "from-[#43D9FA] to-[#FA1CD4]" },
    popular: true,
  },
  {
    title: "Pro+ Plan",
    subtitle: "For studios, labels, and power users.",
    price: "$50",
    planType: "pro_plus",
    credits: 50,
    features: [
